...
constants.greenhouse.structure_mass = 10; % Consult with SE and Structures Teams
...
constants.greenhouse.lightWatts = 64; % Watts. How much power the lights are using, current estimate is based on 2 32 Watt bulbs.
